...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\sandbox\microsemi-tutorial\tutorials\led-blinking\synthesis\LedBlinkingDSpeed.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\sandbox\microsemi-tutorial\tutorials\led-blinking\constraint\io\LedBlinkingDSpeed.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\sandbox\microsemi-tutorial\tutorials\led-blinking\constraint\fp\LedBlinkingDSpeed.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M2500_N \
    -pkg vf256 \
    -pdc_file {D:\sandbox\microsemi-tutorial\tutorials\led-blinking\constraint\io\LedBlinkingDSpeed.io.pdc} \
    -pdc_file {D:\sandbox\microsemi-tutorial\tutorials\led-blinking\constraint\fp\LedBlinkingDSpeed.fp.pdc} \
    -merge_pdc 0
