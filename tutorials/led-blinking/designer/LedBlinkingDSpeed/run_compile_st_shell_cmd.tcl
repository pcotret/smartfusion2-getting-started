...
save
set has_violations {D:\sandbox\microsemi-tutorial\tutorials\led-blinking\designer\LedBlinkingDSpeed\LedBlinkingDSpeed_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {D:\sandbox\microsemi-tutorial\tutorials\led-blinking\designer\LedBlinkingDSpeed\LedBlinkingDSpeed_combinational_loops.xml}
if { [catch "file delete -force -- {D:\sandbox\microsemi-tutorial\tutorials\led-blinking\designer\LedBlinkingDSpeed\pinslacks.txt}"] } {
   ;
}
report -type slack {D:\sandbox\microsemi-tutorial\tutorials\led-blinking\designer\LedBlinkingDSpeed\pinslacks.txt}
